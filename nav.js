document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.body && document.body.id === 'home' && !document.getElementById('oc-home-polish-style')) {
    ...
    style.textContent = [
      ...
      '#home .oc-tool-listing--management .oc-benefit-list li { padding: var(--oc-sp-4) var(--oc-sp-4) var(--oc-sp-4) var(--oc-sp-5); border: var(--oc-border-subordinate) solid rgba(138, 104, 26, 0.22); background: rgba(245, 245, 245, 0.64); color: var(--oc-text-primary); }',
